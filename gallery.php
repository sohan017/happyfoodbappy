...
<head>
	...
	<!-- title -->
	<title>Restaurants-protal</title>
	...
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<!-- favicon -->
	<link rel="shortcut icon" type="image/favicon" href="./image/image/logo/logo/logo/1x/Logo-5.png">
	<!-- bootstrap -->
						...
						<li class="top-home-li t-content">
							...
							<div class="top-content">
								<ul class="top-contect">
									<li><a href="#"><i class="ti-mobile"></i> +351920143746</a></li>
									<li><a href="#"><i class="ti-email"></i> info@fahim.digital</a></li>
								</ul>
							</div>
							<!-- information end -->
						</li>
						<li class="top-home-li">
							<ul class="top-dropdown">
								<li class="top-dropdown-li notification-title">
									<span><i class="icon-social-facebook"></i></span>
								</li>
								<li class="top-dropdown-li notification-title">
					...
					<div class="col">
						<div class="header-main">
							...
							<div class="header-element logo">
								<a href="index.php">
									<img src="./image/image/logo/logo/logo/1x/Logo-2.png" alt="logo-image" class="img-fluid">
								</a>
							</div>
							<!-- logo end -->
							<!-- main menu start -->
        ...
        <div class="mini-cart">
        	...
        	<ul class="subtotal-title-area">
        		...
        		<li class="mini-cart-btns">
        			<div class="cart-btns">
        				<a href="#" class="btn btn-style1"><span>View cart</span></a>
        				<a href="#" class="btn btn-style1"><span>Checkout</span></a>
        			</div>
        		</li>
        	</ul>
        </div>
    			...
    			<div class="col">
    				<div class="section-title">
    					...
    					<ul class="nav nav-tabs">
    						<li class="nav-item">
    							<a class="nav-link active" data-bs-toggle="tab" data-name="all"  href="#home">All</a>
    						</li>
    						<li class="nav-item">
    							<a class="nav-link" data-bs-toggle="tab" href="#home" data-name="bag">Starters</a>
    						</li>
    						<li class="nav-item">
    				...
    				<div class="gallery">
    					<div class="image" data-name="bag"><span><img src="image/gallery/1.jpg" alt=""></span></div>
    					<div class="image" data-name="headphone"><span><img src="image/gallery/2.jpg" alt=""></span></div>
    					<div class="image" data-name="Lunch"><span><img src="image/gallery/3.jpg" alt=""></span></div>
    					<div class="image" data-name="Breakfast"><span><img src="image/gallery/4.jpg" alt=""></span></div>
    					<div class="image" data-name="headphone"><span><img src="image/gallery/5.jpg" alt=""></span></div>
    					<div class="image" data-name="Dinner"><span><img src="image/gallery/6.jpg" alt=""></span></div>
    					<div class="image" data-name="Breakfast"><span><img src="image/gallery/7.jpg" alt=""></span></div>
    					<div class="image" data-name="Lunch"><span><img src="image/gallery/8.jpg" alt=""></span></div>
    				</div>
    			</div>
    		</div>
    	</div>
    	...
    	<div class="wrapper">
    		...
    		<nav>
    			<div class="items">
    				...
    				<!-- <span class="item" data-name="headphone"></span> -->
    			</div>
    		</nav>
    		<!-- filter Images -->
    		<div class="gallery">
    			...
    			<div class="image" data-name="Breakfast"><span><img src="image/gallery/4.jpg" alt=""></span></div>
    			<div class="image" data-name="headphone"><span><img src="image/gallery/5.jpg" alt=""></span></div>
    			<div class="image" data-name="Dinner"><span><img src="image/gallery/4.jpg" alt=""></span></div>
    			<div class="image" data-name="Breakfast"><span><img src="image/gallery/7.jpg" alt=""></span></div>
    			<div class="image" data-name="Lunch"><span><img src="image/gallery/8.jpg" alt=""></span></div>
    		</div>
    	</div>
                ...
                <div class="col">
                    <div class="section-title">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#profile">Breakfats</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" data-bs-toggle="tab" href="#contact">Dinner</a>
                            </li>
                                        ...
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="./image/product/1.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">American mayonise pizza</a></h3>
                                                <div class="rating">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="./image/product/01_00001.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Breakfast eggplant special</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="./image/product/01_00002.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Canadian chezze salad</a></h3>
                                                <div class="rating">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="./image/product/01_00003.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                                    <span class="p-text">New</span>
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Chiekn burger solid</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="./image/product/01_00004.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Chilly garlic bread</a></h3>
                                                <div class="rating">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="image/product/01_00005.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">South indian palakpaner</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="image/product/01_00006.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                                    <span class="p-discount">-10%</span>
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Delicius chiken hotdogs</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="image/product/01_00007.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                                    <span class="p-text">New</span>
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Desc butter chiken</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star b-star"></i>
                                                    <i class="fa fa-star b-star"></i>
                                                    <i class="fa fa-star-o"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="image/product/01_00008.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                                    <span class="p-discount">-12%</span>
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Fryed lupis food</a></h3>
                                                <div class="rating">
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            <div class="tred-pro">
                                                <div class="tr-pro-img">
                                                    <a href="#">
                                                        <img src="image/product/01_00009.jpg" class="img-fluid" alt="image">
                                                    </a>
                                                </div>
                                                <div class="Pro-lable">
                                                    <span class="p-text">New</span>
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Kathiyavadi Gujarati sandvich</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Peri peri chiken</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Special corn noodels</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star d-star"></i>
                                                    <i class="fa fa-star d-star"></i>
                                                    <i class="fa fa-star d-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Special egypt pasta</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">Vegetable italian salad</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                                    <i class="fa fa-star c-star"></i>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="h-t-pro">
                                            ...
                                            <div class="caption">
                                                <h3><a href="#">West indian onionsalad</a></h3>
                                                <div class="rating">
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
                                                    <i class="fa fa-star e-star"></i>
    ...
    <section class="brand_logo">
    	<div class="brand-carousel section-padding owl-carousel">
    		<div class="single-logo">
    			<img src="image/ClientLogo/1.svg" alt="">
    		</div>
    		<div class="single-logo">
    			<img src="image/ClientLogo/2.svg" alt="">
    		</div>
    		<div class="single-logo">
    			<img src="image/ClientLogo/3.svg" alt="">
    		</div>
    		<div class="single-logo">
    			<img src="image/ClientLogo/4.svg" alt="">
    		</div>
    		<div class="single-logo">
    			<img src="image/ClientLogo/5.svg" alt="">
    		</div>
    		<div class="single-logo">
    			<img src="image/ClientLogo/6.svg" alt="">
    		</div>
    	</div>
        ...
        <div class="wrapper">
            ...
            <div class="video_gallery">
                ...
                <div class="slider slider-nav">
                    <div class="gallery_item">
                        <img class="img-fluid" src="image/VT/1.jpg" alt="">
                    </div>
                    <div class="gallery_item">
                        <img class="img-fluid" src="image/VT/2.jpg" alt="">
                    </div>
                    <div class="gallery_item">
                        <img class="img-fluid" src="image/VT/3.jpg" alt="">
                    </div>
                    <div class="gallery_item">
                        <img class="img-fluid" src="image/VT/1.jpg" alt="">
                    </div>
                ...
                <!-- <div class="gallery_item">
                    <img class="img-fluid" src="image/01_00000.jpg" alt="">
                </div>
                <div class="gallery_item">
                    <img class="img-fluid" src="image/01_00000.jpg" alt="">
                </div> -->
