...
<header class="header-area">
            ...
            <div class="items">
                <div class="img-back" style="background-image:url(image/slider1.jpg);">
                    <div class="h-s-content">
                        ...
                        <a href="#" class="btn btn-style1"><span>Shop now</span></a>
                    </div>
                </div>
            </div>
            <div class="items">
                    ...
                    <div class="service">
                            ...
                            <div class="s-box">
                                <div class="service-image">
                                    <a href="javascript:void(0)">
                                        <img src="image/s-image01.png" class="img-fluid" alt="image">
                                    </a>
                                </div>
                        ...
                        <div class="service-box">
                            <div class="s-box">
                                <div class="service-image">
                                    <a href="javascript:void(0)">
                                        <img src="image/s-image02.png" class="img-fluid" alt="image">
                                    </a>
                                </div>
                                <div class="service-content">
                        ...
                        <div class="service-box">
                            <div class="s-box">
                                <div class="service-image">
                                    <a href="javascript:void(0)">
                                        <img src="image/s-image03.png" class="img-fluid" alt="image">
                                    </a>
                                </div>
                                <div class="service-content">
                        ...
                        <div class="service-box">
                            <div class="s-box">
                                <div class="service-image">
                                    <a href="javascript:void(0)">
                                        <img src="image/s-image04.png" class="img-fluid" alt="image">
                                    </a>
                                </div>
                                <div class="service-content">
    ...
    <section class="banner-7">
        <div class="all-banner">
            <div class="banner-area" style="background-image:url('image/product/6.png')">
                <div class="article-img-holder"></div>
                <!-- <div class="banner-grid">
                    <img src="./image/product/6.png" class="img-fluid" alt="banner-image">
                    <a href="#" class="btn btn-style3">Shop now</a>
                </div> -->
            </div>
            <div class="banner-area">
                <div class="off-banner">
                    <img src="image/product/9.png" class="img-fluid" alt="banner-image">
                    <div class="banner-content">
                        <span class="bannre-title">Breakfast time</span>
                        <h2>We deliver <span class="b-off">italian food your door</span></h2>
                    </div>
                </div>
            </div>
            <div class="banner-area" style="background-image:url('image/product/7.png')">
                <div class="article-img-holder"></div>
                <!-- <div class="banner-grid">
                    <img src="image/product/7.png" class="img-fluid" alt="banner-image">
                    <a href="#" class="btn btn-style3">Shop now</a>
                </div> -->
            </div>
            <div class="banner-area" style="background-image:url('image/product/8.png')">
                <div class="article-img-holder"></div>
                <!-- <div class="banner-grid">
                    <img src="image/product/8.png" class="img-fluid" alt="banner-image">
                    <a href="#" class="btn btn-style3">Shop now</a>
                </div> -->
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-lg-3 col-sm-12">
                    <div class="delviery-icon">
                        <a href="">
                            <figure>
                                <img src="image/Resize/1.svg" alt="Foodora">
                            </figure>
                ...
                <div class="col-md-3 col-lg-3 col-sm-12">
                    <div class="delviery-icon">
                        <a href="">
                            <figure>
                                <img src="image/Resize/2.svg" alt="Foodora">
                            </figure>
                            <div class="icon-hover">
                                <i class="fa fa-share fa-4x"></i>
                            </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-12">
                    <div class="delviery-icon">
                        <a href="">
                            <figure>
                                <img src="image/Resize/3.svg" alt="Foodora">
                            </figure>
                            <div class="icon-hover">
                                <i class="fa fa-share fa-4x"></i>
                            </div>
                ...
                <div class="col-md-3 col-lg-3 col-sm-12">
                    <div class="delviery-icon">
                        <a href="">
                            <figure>
                                <img src="image/Resize/4.svg" alt="Foodora">
                            </figure>
                            <div class="icon-hover">
                                <i class="fa fa-share fa-4x"></i>
                            </div>
    ...
    <!-- home delivery end -->
    <!-- testimonial start -->
    <section class="home2-testimonial testimonial2-bg section-tb-padding" style="background-image: url(./image/Testimonial_BG.png); background-size: cover; ">
        <div class="container">
            <div class="row">
                <div class="col">
                    <div class="section-title">
