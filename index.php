...
<html lang="en">
    ...
    <head>
        ...
        <meta
            name="keywords"
            content="organic food theme, vegetables, foof store, eCommerce html template, responsive, electronics store, furniture wood, fashion, furniture, mobile, watches, electronics, computers accessories, toys, jewellery, restaurant accessories"/>
        ...
        <link
            rel="shortcut icon"
            type="image/favicon"
            href="./image/image/logo/logo/logo/1x/Logo-5.png">
        <!-- bootstrap -->
        ...
        <link
            href="./datetime/css/datetimepicker.css"
            rel="stylesheet"
            type="text/css"/>
    ...
    <body class="home-7">
                        ...
                        <div class="col">
                            <div class="header-main">
                                ...
                                <div class="header-element logo">
                                    <a href="#">
                                        <img
                                            src="./image/image/logo/logo/logo/1x/Logo-2.png"
                                            alt="logo-image"
                                            class="img-fluid">
                                    </a>
                                </div>
                                ...
                                <div class="header-element megamenu-content">
                                    <div class="mainwrap pull-right">
                                        <ul class="main-menu">
                                            ...
                                            <!-- <li class="menu-link parent"> <a href="./" class="link-title"> <span
                                            class="sp-link-title">Contact</span> </a> </li> -->
                                        </ul>
                                    </div>
                                </div>
                                <!-- main menu end -->
        ...
        <!-- home delivery start-->
        <section
            class="cl-block table_booking section-bottom-padding"
            style="background-image: url(./image/bg/1.png); background-size: cover;">
            <div class="container">
                <div class="row">
                    <div class="col">
                        <div class="col-md-5">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-12">
                        <div class="footer-bottom hrb">
                            <div class="footer-link">
                                <div class="f-info">
                                    <ul class="footer-first  text-center">
                                        <li class="logo-content text-center">
                                            <a href="#">
                                                <img
                                                    src="./image/image/logo/logo/logo/1x/Logo-footer-1.png"
                                                    class="img-fluid f-logo-image"
                                                    alt="logo-image">
                                            </a>
                                        </li>
